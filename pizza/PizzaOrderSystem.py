...
class Klasik(Pizza):
    ...
    def __init__(self):
        ...
        self.description = " Malzemeler: Sucuk, Mantar, Mısır"
...
class Margarita(Pizza):
    ...
    def __init__(self):
        self.description = " Malzemeler: Domates, Fesleğen, Mozarella"
        print(self.description +"\n")
...
class TurkPizza(Pizza):
    ...
    def __init__(self):
        self.description = "Malzemeler: Sucuk, Pastırma, Biber, Mantar"
        print(self.description +"\n")
...
class SadePizza(Pizza):
    ...
    def __init__(self):
        self.description = " Malzemeler: Kaşar, Mozarella, Kırmızı Biber, Domates, Kekik"
        print(self.description +"\n")
...
def main():
    ...
    while code != "*":
        code = input("Ek Malzeme Almak İçin Tuşlama Yapınız (Direkt Siparişinizi Onaylamak İçin 'Y' Tuşuna Basınız): ")
